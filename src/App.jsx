  ...
  return (
    <Router>
      <div className="glowing-background min-h-screen text-white font-custom">
        ...
        {/* Cart is fixed to the right side, made wider, and background changed to light grey */}
        <div className="fixed top-16 right-4 w-[400px] bg-gray-100 p-4 rounded-lg shadow-xl">
          <CartPage 
            cartItems={cartItems} 
